...
public function store(Request $request)
{
    ...
    try {
        ...
        UserActivity::create([
            ...
            'description' => 'Nouvelle demande de matériel créée par l\'utilisateur avec l\'ID ' . Auth::id() . '.',
        ]);
        ...
        Notification::create([
            ...
            'date_creation' => now(),
            'phrase' => 'Une nouvelle demande de matériel a été créée.',
        ]);
        ...
        try {
            ...
            if (!$demande) {
                ...
                if ($validator->fails()) {
                    ...
                    // Enregistrez l'activité de mise à jour de demande de matériel
                    UserActivity::create([
                        'user_id' => $request->id_demandeur,
                        'activity_type' => 'mise_a_jour_demande_materiel',
                        'description' => 'Demande de matériel mise à jour par l\'utilisateur avec l\'ID ' . $request->id_demandeur . '.',
                    ]);
    ...
    public function validationDemande(Request $request, $id)
    {
        try {
            ...
            if (!$demande) {
                ...
                // Enregistrez l'activité de validation de demande de matériel
                UserActivity::create([
                    'user_id' => $demande->id_demandeur,
                    'activity_type' => 'validation_demande_materiel',
                    'description' => 'Demande de matériel validée par l\'utilisateur avec l\'ID ' . $demande->id_demandeur . '.',
                ]);

                // Enregistrez la notification
                $notificationPhrase = $this->getNotificationPhrase('validation_demande');
                Notification::create([
        ...
        try {
            ...
            if (!$demande) {
                ...
                UserActivity::create([
                    ...
                    'description' => 'Demande de matériel rejetée par l\'utilisateur avec l\'ID ' . $demande->id_demandeur . '.',
                ]);
