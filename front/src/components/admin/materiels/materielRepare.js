...
const MaterielRepare = () => {
  ...
  const refreshData = () => {
    axios
      .get('http://127.0.0.1:8000/api/materiel_repare', {
        headers: {
    ...
    <Box sx={{ height: 400, width: '100%' }}>
      ...
      {isLoading ? (
        ...
        <Typography variant="body1" sx={{ textAlign: 'center', mt: 3, mb: 3 }}>
          Aucun matériel réparé disponible.
        </Typography>
      )}
    </Box>
  );
